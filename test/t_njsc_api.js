 ...
 *			curl --data @- 'http://localhost:8080/putschema/user?fullname=com.wandoujia.chana.demoschema.User'
 * 		> curl -s 'http://localhost:8080/user/get/1' | node viewer.js
 *
 * there are full testcases:
**/

var user_centre = require('../njsc_api.js').option({uri: 'http://127.0.0.1:8080'}).at('user')
var activities = require('../njsc_api.js').option({uri: 'http://127.0.0.1:8080'}).at('activity')
...
con2.next(activities, ['putschema',
		...
		{fullname: 'com.wandoujia.chana.demoschema.ActivityRecord', timeout: 2*60*60*1000},
